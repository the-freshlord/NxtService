...
public class PlaceDetails: CustomStringConvertible {
  ...
  public init(json: [String: AnyObject]) {
    ...
    // MARK: -Emanuel custom code for getting the formatted address
...
public class GooglePlacesAutocomplete: UINavigationController {
  ...
  public convenience init(apiKey: String, placeType: PlaceType = .All) {
    ...
    // MARK: - Emanuel custom code for styling
    navigationBar.barStyle = UIBarStyle.Black
    navigationBar.translucent = false
    navigationBar.barTintColor = UIColor(red: 62.0 / 255.0, green: 180.0 / 255.0, blue: 137.0 / 255.0, alpha: 1.0)
    navigationBar.tintColor = UIColor(red: 244.0 / 255.0, green: 251.0 / 255.0, blue: 255.0 / 255/0, alpha: 1.0)
    navigationBar.titleTextAttributes = [NSFontAttributeName: UIFont(name: "Viafont", size: 16.0)!]
  }
